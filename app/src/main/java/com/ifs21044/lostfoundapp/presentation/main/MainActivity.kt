...
import com.ifs21044.lostfoundapp.adapter.TodosAdapter
...
import com.ifs21044.lostfoundapp.data.remote.response.TodosItemResponse
import com.ifs21044.lostfoundapp.databinding.ActivityMainBinding
...
import com.ifs21044.lostfoundapp.presentation.lostandfound.LostfoundActivity
import com.ifs21044.lostfoundapp.presentation.profile.ProfileActivity
import com.ifs21044.lostfoundapp.presentation.todo.TodoDetailActivity
import com.ifs21044.lostfoundapp.presentation.todo.TodoManageActivity
                        ...
                        when (it) {
                            is MyResult.Error -> {
                                if (isChecked) {
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Gagal menemukan barang: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                } else {
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Gagal batal menemukan barang: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                }
                            }
                            is MyResult.Success -> {
                                if (isChecked) {
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Berhasil menemukan barang: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                } else {
                                    Toast.makeText(
                                        this@MainActivity,
                                        "Berhasil batal menemukan barang: " + todo.title,
                                        Toast.LENGTH_SHORT
                                    ).show()
                                }
                            }
