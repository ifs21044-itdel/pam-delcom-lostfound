...
import com.ifs21044.lostfoundapp.adapter.LosfoundAdapter
...
import com.ifs21044.lostfoundapp.databinding.ActivityLostfoundBinding
...
import com.ifs21044.lostfoundapp.presentation.main.MainActivity
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.tab_home -> {
                    ...
                    startActivity(Intent(this@LostfoundActivity, MainActivity::class.java))
                    finish()
                    true
                }
                R.id.tab_lostfound -> {
                    // Tidak melakukan apa-apa karena sudah berada di halaman LostfoundActivity
                    true
                }
                else -> false
            }
